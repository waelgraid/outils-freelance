...
const faqItems = [
  {
    ...
    "a": "Cela depend de votre CA. En dessous de 36 800EUR de CA annuel, vous beneficiez de la franchise en base de TVA. Au-dessus, vous facturez la TVA a 20% sur vos prestations. Certaines prestations artistiques peuvent beneficier du taux reduit — renseignez-vous aupres d'un comptable."
  },
  {
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 leading-relaxed mb-4 max-w-3xl">Graphiste, illustrateur, directeur artistique, motion designer... les creatifs freelances ont des besoins specifiques : suivi du temps passe par projet, facturation au forfait ou au taux horaire, gestion des droits de cession et relances elegantes. Voici notre selection.</p>
        <p className="text-gray-600 leading-relaxed mb-10 max-w-3xl">En tant que graphiste independant, vous jongler souvent entre plusieurs clients et projets en meme temps. Votre logiciel de facturation doit vous permettre de suivre le temps passe, de generer des factures professionnelles qui valorisent votre travail et de ne jamais perdre de vue les paiements en attente.</p>
