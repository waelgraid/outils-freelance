...
export const metadata: Metadata = {
  title: 'Meilleur logiciel de facturation pour graphiste 2026',
  description: 'Quel logiciel de facturation pour graphiste freelance en 2026 ? Freebe, Indy, Abby : comparatif adapté aux createurs et designers indépendants.',
  alternates: { canonical: 'https://www.outils-freelance.fr/logiciel-facturation-graphiste/' },
  openGraph: {
    title: 'Meilleur logiciel de facturation pour graphiste 2026',
    description: 'Quel logiciel de facturation pour graphiste freelance en 2026 ? Freebe, Indy, Abby : comparatif adapté aux createurs et designers indépendants.',
    url: 'https://www.outils-freelance.fr/logiciel-facturation-graphiste/',
    type: 'website',
    locale: 'fr_FR',
...
const faqItems = [
  ...
  {
    "q": "Freebe est-il adapté aux graphistes qui debutent ?",
    "a": "Freebe est ideal des le debut de votre activite. Son interface simple guide la creation de devis et factures pas-a-pas. A 9,99€/mois, c'est un investissement vite rentabilise si ca vous evite un seul impaye grace aux relances automatiques."
  },
  {
    "q": "Comment facturer des droits de cession en tant que graphiste ?",
    "a": "Les droits de cession de droits d'auteur peuvent etre inclus dans vos factures de prestation ou factures separement. Avec Freebe ou Indy, vous pouvez créer des lignes de facturation personnalisees pour les droits de cession avec les mentions legales appropriees."
  },
  {
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Meilleur logiciel de facturation pour graphiste 2026</h1>
        ...
        <div className="overflow-x-auto mb-8">
          <h2 className="text-xl font-bold mb-4">Tableau comparatif des logiciels pour graphistes</h2>
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Suivi de projet</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Paiement en ligne</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Comptabilité BNC</th>
              </tr>
            </thead>
            <tbody>
              {[
                { name: 'Freebe', price: '9€/mois', projet: '✅ Excellent', paiement: '✅', bnc: '✅' },
                { name: 'Abby', price: 'Gratuit / 6€/mois', projet: '⚠️ Basique', paiement: '✅', bnc: '✅' },
                { name: 'Indy', price: 'Gratuit / 9€/mois', projet: '❌', paiement: '✅', bnc: '✅ Automatisé' },
              ].map((row, i) => (
                <tr key={row.name} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  ...
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.projet}</td>
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.paiement}</td>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <Link href="/graphiste" className="card p-3.5 flex items-center gap-2 hover:border-indigo-200 group">
              <span className="text-sm font-medium group-hover:text-indigo-600">Guide complet graphiste freelance &rarr;</span>
            </Link>
