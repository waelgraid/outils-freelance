...
export const metadata: Metadata = {
  title: 'Meilleur logiciel de facturation pour médecin libéral 2026',
  ...
  openGraph: {
    title: 'Meilleur logiciel de facturation pour médecin libéral 2026',
    description: 'Quel logiciel de facturation pour médecin libéral en 2026 ? Indy, Pennylane : comparatif adapté aux professions médicales indépendantes.',
    url: 'https://www.outils-freelance.fr/logiciel-facturation-medecin/',
    type: 'website',
    locale: 'fr_FR',
...
export default function Page() {
  ...
  return (
    <>
      ...
      />
      <StickyBar toolSlug="indy" toolName="Indy" toolUrl="https://www.indy.fr/?ae=1514" trialLabel="Version gratuite disponible" bg="#6C5CE7" />
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-indigo-50 border-2 border-indigo-200 rounded-2xl p-5 mb-8 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 text-xs flex-wrap">
              ...
              <span className="text-gray-500">Gratuit puis 20€/mois</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          ...
          <div key="Facturation des depa" className="card p-4">
            <div className="font-semibold text-gray-900 mb-1">Facturation des dépassements</div>
            <p className="text-sm text-gray-600">Gestion des honoraires en secteur 1, 2 et 3, avec dépassements et forfaits.</p>
          </div>
        ...
        <div className="overflow-x-auto mb-8">
          <h2 className="text-xl font-bold mb-4">Tableau comparatif des logiciels pour médecins libéraux</h2>
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Déclaration 2035</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Comptabilité BNC</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Expert-comptable</th>
              </tr>
            </thead>
            <tbody>
              {[
                { name: 'Indy', price: 'Gratuit / 9€/mois', d2035: '✅ Automatisé', bnc: '✅', expert: '⚠️ Basique' },
                { name: 'Pennylane', price: '30€/mois', d2035: '✅', bnc: '✅ Avancé', expert: '✅ Collaboratif' },
                { name: 'Abby', price: 'Gratuit / 6€/mois', d2035: '⚠️ Basique', bnc: '✅', expert: '❌' },
              ].map((row, i) => (
                <tr key={row.name} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  ...
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.d2035}</td>
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.bnc}</td>
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.expert}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <Link href="/medecin-liberal" className="card p-3.5 flex items-center gap-2 hover:border-indigo-200 group">
              <span className="text-sm font-medium group-hover:text-indigo-600">Guide complet médecin libéral &rarr;</span>
            </Link>
