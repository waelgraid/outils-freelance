...
const faqItems = [
  ...
  },
  {
    ...
    "a": "Pas necessairement. Si votre CA annuel est inferieur a 36 800EUR pour les prestations de services, vous beneficiez de la franchise en base de TVA. Au-dessus, vous devez facturer la TVA a 20% et la declarer. Indy et Pennylane gerent automatiquement la TVA des que vous etes assujetti."
  },
  {
...
export default function Page() {
  ...
  return (
    <>
      ...
      />
      <StickyBar toolSlug="pennylane" toolName="Pennylane" toolUrl="https://www.pennylane.com/?ref=outils-freelance" trialLabel="15 jours gratuits" bg="#4F46E5" />
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 leading-relaxed mb-4 max-w-3xl">En tant que consultant independant (management, marketing, RH, finance, IT...), vous facturerez souvent de gros montants a des clients grands comptes qui exigent des factures conformes et un suivi rigoureux. Voici les outils les mieux adaptes.</p>
        <p className="text-gray-600 leading-relaxed mb-10 max-w-3xl">Le choix du bon logiciel de facturation est crucial pour un consultant : il conditionne votre image professionnelle aupres de vos clients, la rapidite de vos encaissements et la qualite de votre suivi comptable. Un outil adapte peut faire gagner plusieurs heures par mois.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div key="Factures grands comp" className="card p-4">
            ...
            <p className="text-sm text-gray-600">Vos clients entreprises exigent des factures avec mentions legales completes, numero de TVA intracommunautaire et format normé.</p>
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <Link key="/logiciel-facturation-auto-entrepreneur" href="/logiciel-facturation-auto-entrepreneur" className="card p-3.5 flex items-center gap-2 hover:border-indigo-200 group">
              <span className="text-sm font-medium group-hover:text-indigo-600">Logiciel auto-entrepreneur &rarr;</span>
            </Link>
          </div>
        </div>
      </div>
