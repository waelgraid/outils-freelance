...
const faqItems = [
  ...
  },
  {
    ...
    a: "Depuis le 1er septembre 2026, toutes les entreprises assujetties à la TVA doivent pouvoir recevoir des factures électroniques via une plateforme agréée. L'émission devient obligatoire pour les micro-entreprises au 1er septembre 2027. Abby et Indy sont conformes et gèrent cette transition automatiquement."
  },
  {
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 mb-8">
          <h2 className="font-bold text-gray-900 mb-4">Ce dont vous avez besoin</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-5">Comparatif 2026</h2>
