    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 leading-relaxed mb-10 max-w-3xl">
          Qonto et Shine dominent le marche des banques pro pour independants en France. IBAN francais, carte Visa, facturation intégrée : les deux cochent les cases essentielles. Mais laquelle vous convient le mieux ?
        </p>
