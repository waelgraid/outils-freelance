...
const faqItems = [
  ...
  },
  {
    ...
    a: "Oui, les deux logiciels s'intégrént avec les principales banques pro francaises (Qonto, Shine, BNP, Credit Agricole...). La connexion bancaire synchronise automatiquement vos transactions pour eviter la saisie manuelle."
  },
  {
...
export default function PennylaneVsIndyPage() {
  ...
  return (
    <>
      ...
      />
      <StickyBar toolSlug="indy" toolName="Indy" toolUrl="https://www.indy.fr/inscription?ae=1514" trialLabel="Gratuit à vie" bg="#6C5CE7" />
