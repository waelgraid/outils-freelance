...
const faqItems = [
  {
    ...
    a: "Pennylane peut etre utilise par des auto-entrepreneurs, mais son prix de depart (26€/mois) est difficile a justifier face a Indy gratuit ou Abby a 5,40€/mois. Pennylane prend tout son sens pour les SASU, EURL et entreprises avec un CA superieur a 50 000€ par an."
  },
  {
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 leading-relaxed mb-10">
          ...
          A 26€/mois minimum, il s&apos;adresse surtout aux SASU, EURL et EI avec CA superieur a 50 000€.
        </p>
