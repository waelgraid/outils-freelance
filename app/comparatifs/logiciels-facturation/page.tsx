...
const faqItems = [
  {
    ...
    a: "Abby et Indy proposent tous les deux une version gratuite très complète. Abby est idéal pour les artisans (devis, TVA multi-taux), Indy est plus adapté aux professions libérales BNC (comptabilité automatisée, déclaration 2035). Les deux gèrent les déclarations URSSAF gratuitement.",
  },
  {
    q: 'Un auto-entrepreneur est-il obligé d\'utiliser un logiciel de facturation ?',
    a: "Plus vraiment. Depuis le 1er septembre 2026, vous devez pouvoir recevoir des factures électroniques via une plateforme agréée, et à partir du 1er septembre 2027 vos factures B2B devront être émises au format structuré. Word et Excel ne sont pas conformes : la migration vers un logiciel dédié est devenue incontournable.",
  },
  {
    q: 'Quelle est la différence entre Abby, Indy et Freebe ?',
    a: "Abby est le plus polyvalent (artisans, prestataires, devis avec acomptes). Indy est spécialisé BNC et automatise la comptabilité libérale. Freebe est conçu pour les consultants et freelances en mission avec suivi du temps et rentabilité par client.",
  },
  {
    q: 'Faut-il un logiciel payant pour gérer la TVA en auto-entreprise ?',
    a: "Oui pour les fonctionnalités avancées de TVA. Les versions gratuites d'Abby et Indy gèrent les bases, mais pour la déclaration TVA automatisée, la récupération de TVA et les taux multiples (10%/20%), il faut généralement passer en version payante (6 à 9€/mois).",
  },
  {
    q: 'Pennylane vaut-il vraiment 30€/mois pour un freelance ?',
    a: "Pennylane est justifié à partir de 40 000-50 000€ de CA annuel, en SASU, ou si vous travaillez avec un expert-comptable. Pour un micro-entrepreneur standard, Abby ou Indy à 0-9€/mois couvrent 90% des besoins. Le vrai avantage de Pennylane est la collaboration temps réel avec un comptable.",
  },
]
