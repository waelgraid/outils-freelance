...
export default function BanquesProPage() {
  ...
  return (
    <>
      ...
      />
      <StickyBar toolSlug="qonto" toolName="Qonto" toolUrl="https://qonto.com/fr/open-account?ref=outils-freelance" trialLabel="30 jours gratuits" bg="#FF5A50" />
