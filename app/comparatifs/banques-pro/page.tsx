...
const faqItems = [
  ...
  },
  {
    ...
    a: "Pour les auto-entrepreneurs, un extrait d'immatriculation ou le certificat de l'URSSAF suffit. Pour les societes (SASU, EURL), le Kbis est nécessaire. Qonto et Shine permettent d'ouvrir un compte en ligne en moins de 10 minutes avec ces documents."
  },
]
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="badge-blue mb-3">Mis à jour {EDITORIAL.lastUpdate}</div>
