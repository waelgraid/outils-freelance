...
export const metadata: Metadata = {
  title: 'Meilleure mutuelle freelance 2026 : 3 offres comparées dès 22€',
  description: 'Alan, Wemind ou April Santé ? Comparatif indépendant des 3 meilleures mutuelles freelance en 2026 : prix réels dès 22€/mois, remboursements et garanties dentaires.',
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Alan est la néo-mutuelle digitale : remboursements en 24h, tout depuis l'application, téléconsultation incluse — idéal pour les freelances qui veulent une expérience 100% en ligne. Wemind est spécialisée freelances avec le tarif le plus compétitif du marché (dès 22€/mois) et une communauté d'indépendants. April Santé propose la gamme TNS la plus large, avec un dentaire jusqu'à 550 % de la base de remboursement — recommandé si vous êtes au régime réel (EI, EURL) et souhaitez bénéficier de la loi Madelin.",
  },
  {
    q: 'Les cotisations de mutuelle sont-elles déductibles pour un freelance ?',
    a: "En micro-entreprise, la déduction n'est pas possible — le régime micro applique un abattement forfaitaire qui remplace toute déduction de charges. La déduction via la loi Madelin est uniquement disponible pour les travailleurs non salariés au régime réel (EI au réel, gérant d'EURL, gérant majoritaire de SARL). Le président de SASU, assimilé salarié, n'y a pas droit. Dans ce cas, April Santé propose des contrats Madelin adaptés. Renseignez-vous auprès d'un expert-comptable.",
  },
  {
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  { crit: 'Souscription en ligne', alan: '✅ 100%', wemind: '✅ 100%', april: '✅ 100% (tarif sur devis)' },
                  { crit: 'Remboursements', alan: '✅ 24h', wemind: '✅ Rapides', april: '⚠️ Standard' },
                  { crit: 'Téléconsultation', alan: '✅ Incluse', wemind: '✅ Incluse', april: '⚠️ Selon la gamme' },
                  { crit: 'Garanties dentaire', alan: '⚠️ Correct', wemind: '✅ Bon', april: '✅ Jusqu\'à 550 % BR' },
                  { crit: 'Loi Madelin (TNS au réel)', alan: '❌ Non', wemind: '❌ Non', april: '✅ Oui' },
        ...
        <div className="bg-gray-50 rounded-2xl p-6 mb-12">
          ...
          <div className="space-y-3">
            {[
              ...
              { profil: 'Je suis au régime réel (EI, EURL) ou en profession libérale', choix: 'April Santé', raison: 'Contrats Madelin, dentaire jusqu\'à 550 % BR' },
              { profil: 'Je veux aussi une RC Pro pour mon activité', choix: 'Wemind', raison: 'Wemind propose RC Pro + mutuelle santé en un seul contrat pour freelances' },
            ].map(r => (
