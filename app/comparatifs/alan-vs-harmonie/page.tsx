...
const faqItems = [
  ...
  {
    q: 'Alan est-il adapte aux familles avec enfants ?',
    a: "Oui, Alan propose des formules familiales avec des tarifs par enfant. L'application mobile permet de gerer toute la famille, de suivre les remboursements et d'acceder a la teleconsultation pour tous les membres. C'est une option interessante pour les freelances avec enfants."
  },
  {
