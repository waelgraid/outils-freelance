...
const faqItems = [
  ...
  },
  {
    ...
    a: "Non. En micro-entreprise, le régime fiscal forfaitaire ne permet pas de déduire les charges réelles, y compris les cotisations de mutuelle. La déduction via la loi Madelin est réservée aux travailleurs non salariés au régime réel (EI au réel, gérant d'EURL, gérant majoritaire de SARL). Le président de SASU, assimilé salarié, n'en relève pas : le traitement fiscal de sa complémentaire suit d'autres règles, à valider avec un expert-comptable.",
  },
  {
...
export const metadata: Metadata = {
  title: 'Alan vs Wemind 2026 : 39€ ou 22€/mois, notre verdict',
  description: 'Alan à 39€/mois ou Wemind à 22€/mois ? Comparatif détaillé 2026 : remboursements, garanties dentaires, résiliation. Notre verdict selon votre profil freelance.',
