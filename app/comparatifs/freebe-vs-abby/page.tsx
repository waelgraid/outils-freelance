...
const faqItems = [
  ...
  {
    q: 'Freebe propose-t-il un suivi du temps integre ?',
    a: "Oui, c'est l'une des grandes forces de Freebe. Vous pouvez pointer vos heures directement dans l'application, par mission ou par client, et generer une facture basee sur le temps pointe. C'est une fonctionnalite cle pour les freelances en services qui facturent au temps passe."
  },
  {
    q: 'Abby est-il adapte aux freelances creatifs (designers, redacteurs) ?',
    a: 'Oui, Abby convient bien aux freelances creatifs pour la facturation pure. En revanche, il ne propose pas de suivi du temps ni de gestion de missions, contrairement a Freebe. Si vous avez besoin de suivre vos heures par projet, Freebe est plus adapte.'
  },
  {
  ...
  {
    q: 'Lequel de Freebe ou Abby est le plus adapte pour un artisan ?',
    a: "Abby est clairement plus adapte pour les artisans. Il gere les devis sur mobile, les taux de TVA multiples (10% et 20%), les acomptes et la facturation de materiaux. Freebe est concu pour les freelances en services et n'est pas optimise pour les metiers de l'artisanat."
  }
]
...
export default function FreebeVsAbbyPage() {
  ...
  const criteria = [
    ...
    { label: 'Suivi du temps',           a: 'Integre',                b: 'Non disponible',       winner: 'freebe' },
    { label: 'Gestion des missions',     a: 'Complete',               b: 'Basique',              winner: 'freebe' },
    { label: 'Facturation electronique', a: 'Certifie',               b: 'Certifie PA',          winner: 'abby' },
    ...
    { label: 'Adapte artisans',          a: 'Non',                    b: 'Oui',                  winner: 'abby' },
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
          <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              <li>&#10003; Vous etes freelance en services (dev, design, conseil)</li>
        ...
        <div className="bg-gray-50 rounded-2xl p-6 text-center mb-10">
          <p className="text-sm text-gray-600 mb-4"><strong>Freelance en services</strong> : Freebe. <strong>Auto-entrepreneur generaliste</strong> : Abby.</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              { href: '/outils/freebe', title: 'Avis Freebe' },
              { href: '/outils/abby', title: 'Avis Abby' },
            ].map(r => (
