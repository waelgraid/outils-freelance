...
export const metadata: Metadata = {
  title: 'Meilleur logiciel de gestion auto-entrepreneur 2026',
  description: 'Quel logiciel de gestion pour auto-entrepreneur en 2026 ? Facturation, comptabilité, banque pro : notre sélection complète pour gérer votre activité.',
  alternates: { canonical: 'https://www.outils-freelance.fr/comparatifs/logiciels-gestion/' },
  openGraph: {
    title: 'Meilleur logiciel de gestion auto-entrepreneur 2026',
    description: 'Quel logiciel de gestion pour auto-entrepreneur en 2026 ? Facturation, comptabilité, banque pro : notre sélection complète pour gérer votre activité.',
    url: 'https://www.outils-freelance.fr/comparatifs/logiciels-gestion/',
    type: 'website',
    locale: 'fr_FR',
...
const faqItems = [
  ...
  },
  {
    ...
    a: 'Pour les micro-entrepreneurs, un bon logiciel comme Indy ou Abby suffit pour la gestion courante : facturation, livre des recettes, déclarations URSSAF. Pour les structures soumises à l\'IS (SASU, €L) ou en cas de TVA complexe, un expert-comptable reste recommandé — mais les logiciels modernes comme Pennylane réduisent significativement ses honoraires.',
  },
  {
  ...
  },
  {
    ...
    a: 'Oui. Abby et Indy sont conformes et s\'interfacent avec une plateforme agréée. Vos factures sont générées au format Factur-X. L\'obligation de réception s\'applique depuis le 1er septembre 2026, l\'émission au 1er septembre 2027 pour les micro-entreprises. Pennylane et Freebe sont également conformes.',
  },
]
