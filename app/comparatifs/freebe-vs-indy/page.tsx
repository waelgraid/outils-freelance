...
export const metadata: Metadata = {
  title: 'Freebe vs Indy 2026 : lequel choisir ?',
  ...
  openGraph: {
    title: 'Freebe vs Indy 2026 : lequel choisir ?',
    description: 'Freebe ou Indy ? Comparatif complet 2026 : tarifs, fonctionnalités, suivi du temps, comptabilité. Notre verdict pour choisir le meilleur outil freelance.',
    url: 'https://www.outils-freelance.fr/comparatifs/freebe-vs-indy/',
    type: 'website',
    locale: 'fr_FR',
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Oui, les deux sont conformes à la réforme. Ils génèrent des factures au format Factur-X et s'interfacent avec une plateforme agréée. L'obligation de réception s'applique depuis le 1er septembre 2026, l'émission au 1er septembre 2027 pour les micro-entreprises."
  },
]
...
export default function FreebeVsIndyPage() {
  ...
  const criteria = [
    ...
    { label: 'Prix de depart',           a: '9,99€/mois',          b: '0€/mois',               winner: 'indy' },
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
          <div className="card p-5">
            ...
            <div className="space-y-3 text-sm">
              {[
                ...
                { label: 'Solo', price: '9,99 €/mois' },
                { label: 'Solo (annuel)', price: '7,99 €/mois' },
                { label: 'Pro', price: '16,99 €/mois' },
              ].map((t, i, arr) => (
          ...
          <div className="card p-5">
            ...
            <div className="space-y-3 text-sm">
              {[
                { label: 'Gratuit (a vie)', price: '0 €/mois', green: true },
