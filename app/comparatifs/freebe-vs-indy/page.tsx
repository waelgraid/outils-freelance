...
const faqItems = [
  {
    ...
    a: "Oui, Indy propose une version gratuite permanente très complète (facturation illimitée, connexion bancaire, déclarations URSSAF). Freebe ne propose pas de version gratuite permanente mais offre 2 mois d'abonnement offerts via notre lien partenaire. Après ces 2 mois, Freebe est à 9,99€/mois."
  },
  {
...
export default function FreebeVsIndyPage() {
  ...
  const criteria = [
    ...
    { label: 'CRM missions',             a: 'Integre',               b: 'Non disponible',          winner: 'freebe' },
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-10">
          ...
          <p className="text-sm text-amber-800">
            <strong>Choisissez Freebe</strong> si vous facturez en régie (TJM), avez besoin de suivi du temps et de CRM missions — et profitez des 2 mois offerts via notre lien.
            <br />
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          ...
          À 9,99€/mois, c&apos;est l&apos;outil le plus complet pour les freelances en services — et vous bénéficiez de <strong>2 mois offerts</strong> via notre lien partenaire.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
          <div className="card p-5">
            ...
            <div className="space-y-3 text-sm">
              {[
                { label: '2 mois offerts (offre exclusive)', price: 'Via notre lien', green: true },
        ...
        <div className="bg-gray-50 rounded-2xl p-6 text-center mb-12">
          <p className="text-sm text-gray-600 mb-4">
            <strong>Freelance en régie</strong> : Freebe avec 2 mois offerts via notre lien.
