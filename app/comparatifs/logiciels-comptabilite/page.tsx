...
export const metadata: Metadata = {
  title: 'Meilleur logiciel de comptabilité freelance 2026',
  description: 'Quel logiciel de comptabilité choisir en 2026 pour freelance ou auto-entrepreneur ? Indy, Pennylane, Abby : comparatif tarifs, fonctionnalités et avis.',
  alternates: { canonical: 'https://www.outils-freelance.fr/comparatifs/logiciels-comptabilite/' },
  openGraph: {
    title: 'Meilleur logiciel de comptabilité freelance 2026',
    description: 'Quel logiciel de comptabilité choisir en 2026 pour freelance ou auto-entrepreneur ? Indy, Pennylane, Abby : comparatif tarifs, fonctionnalités et avis.',
    url: 'https://www.outils-freelance.fr/comparatifs/logiciels-comptabilite/',
    type: 'website',
    locale: 'fr_FR',
...
const faqItems = [
  {
    q: 'Quel est le meilleur logiciel de comptabilité gratuit pour auto-entrepreneur ?',
    a: "Indy est le meilleur logiciel de comptabilité gratuit pour auto-entrepreneurs en 2026. Sa version gratuite inclut la facturation illimitee, le livre des recettes, les declarations URSSAF et la connexion bancaire automatique. C'est la version gratuite la plus complete du marche."
  },
  {
    q: 'Un auto-entrepreneur a-t-il besoin d\'un logiciel de comptabilite ?',
    a: "En tant qu'auto-entrepreneur, vous n'etes pas soumis a l'obligation de tenir une comptabilite complete, mais vous devez tenir un livre des recettes et un registre des achats. Un logiciel de comptabilité simplifie énormément cette gestion et vous evite des erreurs qui peuvent couter cher lors d'un controle URSSAF."
  },
  {
    q: 'Quelle est la difference entre un logiciel de facturation et un logiciel de comptabilité ?',
  ...
  {
    q: 'Les logiciels de comptabilité sont-ils conformes aux obligations legales françaises ?',
    a: "Oui, les logiciels référencés sur notre site sont tous conformes a la legislation française : loi anti-fraude TVA 2018, futures obligations de facturation electronique, et format FEC (Fichier des Ecritures Comptables) pour les controles fiscaux. Verifiez toujours la mention NF 203 ou l'attestation de conformite."
  },
  {
    q: 'Faut-il un expert-comptable si on utilise un logiciel de comptabilite ?',
    a: "Pour un micro-entrepreneur, un bon logiciel comme Indy suffit generalement pour gerer sa comptabilite au quotidien. Pour une societe (SASU, €L) ou en cas de TVA, un expert-comptable reste recommande — mais les logiciels modernes comme Pennylane facilitent la collaboration et reduisent les honoraires."
  },
]
...
export default function LogicielsComptabilitePage() {
  ...
  return (
    <>
      ...
      />
      <StickyBar toolSlug="indy" toolName="Indy" toolUrl="https://www.indy.fr/?ae=1514" trialLabel="Gratuit pour toujours" bg="#6C5CE7" />
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 leading-relaxed mb-4 max-w-3xl">
          Gerer sa comptabilite quand on est indépendant est une obligation legale, mais ca ne doit pas etre une corvee.
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 mb-10">
          <div className="space-y-4">
            {[
              { n: '1', t: 'Votre statut juridique', d: "Micro-entrepreneur ? Indy gratuit ou Abby suffisent. SASU ou €L avec TVA ? Pensez a Pennylane ou Indy payant pour une comptabilite complete." },
              ...
              { n: '3', t: 'Le besoin de collaboration', d: "Si vous avez un expert-comptable, privilegiez Pennylane qui offre une interface de collaboration dédiée. Pour gerer seul, Indy ou Abby sont parfaits." },
              { n: '4', t: 'Le budget', d: "De 0€/mois (Indy gratuit) a 26€/mois (Pennylane). Pour un auto-entrepreneur debutant, commencez gratuit avec Indy — vous pourrez upgrader si besoin." },
            ].map(c => (
