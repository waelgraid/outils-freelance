...
export const metadata: Metadata = {
  ...
  description: 'Quel logiciel de comptabilité choisir en 2026 pour freelance ou auto-entrepreneur ? Indy, Pennylane, Abby : comparatif tarifs, fonctionnalites et avis.',
...
export default function LogicielsComptabilitePage() {
  ...
  return (
    <>
      ...
      />
      <StickyBar toolSlug="indy" toolName="Indy" toolUrl="https://www.indy.fr/inscription?ae=1514" trialLabel="Gratuit pour toujours" bg="#6C5CE7" />
