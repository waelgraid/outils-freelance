...
const faqItems = [
  {
    ...
    a: 'Oui, Indy propose une version gratuite à vie qui inclut la facturation illimitee, le livre des recettes, les declarations URSSAF et la connexion bancaire de base. La version payante (à partir de 20EUR/mois) ajoute la comptabilite avancee, le bilan et la gestion de TVA.'
  },
  {
  ...
  },
  {
    ...
    a: "Oui, les deux logiciels sont certifiés et conformes a la legislation francaise, notamment la loi anti-fraude TVA 2018 et la future facturation electronique obligatoire. Ils génèrent des factures avec toutes les mentions legales requises."
  },
  {
  ...
  },
  {
    ...
    a: "Oui, Indy et Abby sont tous les deux certifiés Plateforme de Dematerialisation Partenaire (PDP) pour la facturation electronique obligatoire qui concerne progressivement toutes les entreprises francaises à partir de 2026."
  },
]
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          ...
          tableau de bord. Tout ce dont un micro-entrepreneur a besoin sans payer un centime. Le plan payant (à partir de 20EUR/mois) ajoute
          ...
          <div className="card p-5">
            ...
            <div className="space-y-3 text-sm">
              {[
                ...
                { label: 'Sans engagement', price: 'à partir de 9 EUR/mois' },
              ].map((t, i, arr) => (
                <div key={t.label} className={`flex justify-between pb-2 ${i < arr.length - 1 ? 'border-b border-gray-50' : ''}`}>
                  <span className="text-gray-600">{t.label}</span>
                  <span className={`font-semibold ${t.green ? 'text-green-600' : ''}`}>{t.price}</span>
