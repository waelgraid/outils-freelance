...
export const metadata: Metadata = {
  ...
  description: 'Comparatif Indy vs Abby 2026 : fonctionnalités, tarifs, points forts et faibles. Tests complets et verdict pour choisir le meilleur logiciel auto-entrepreneur.',
  alternates: { canonical: 'https://www.outils-freelance.fr/comparatifs/indy-vs-abby/' },
  openGraph: {
    title: 'Indy vs Abby 2026 : lequel choisir pour votre micro-entreprise ?',
    description: 'Comparatif Indy vs Abby 2026 : fonctionnalités, tarifs, points forts et faibles. Tests complets et verdict pour choisir le meilleur logiciel auto-entrepreneur.',
    url: 'https://www.outils-freelance.fr/comparatifs/indy-vs-abby/',
    type: 'website',
    locale: 'fr_FR',
...
const faqItems = [
  {
    ...
    a: 'Oui, Indy propose une version gratuite à vie qui inclut la facturation illimitee, le livre des recettes, les declarations URSSAF et la connexion bancaire de base. La version payante (à partir de 20€/mois) ajoute la comptabilite avancee, le bilan et la gestion de TVA.'
  },
  {
    q: 'Abby ou Indy : lequel est le mieux pour un auto-entrepreneur qui debute ?',
    a: "Pour un débutant, Abby est souvent plus accessible grace a son interface tres guidee et sa prise en main rapide. Indy convient mieux aux profils qui veulent automatiser rapidement leur comptabilite via connexion bancaire. Les deux proposent un essai gratuit, testez les deux !"
  },
  {
  ...
  },
  {
    ...
    a: "Oui, les deux logiciels sont certifiés et conformes a la legislation française, notamment la loi anti-fraude TVA 2018 et la future facturation electronique obligatoire. Ils génèrent des factures avec toutes les mentions legales requises."
  },
  {
    q: 'Quelle est la difference principale entre Indy et Abby ?',
    a: "Indy est davantage oriente comptabilite automatisee (connexion bancaire puissante, declarations intégrées) et convient tres bien aux freelances BNC. Abby est plus complet pour la gestion quotidienne (devis, factures, paiement en ligne) et mieux adapté aux artisans et commercants."
  },
  {
    q: 'Les deux logiciels gerent-ils la facturation electronique obligatoire 2026 ?',
    a: "Oui, Indy et Abby sont tous les deux conformes à la facturation électronique. L'obligation de réception via une plateforme agréée s'applique depuis le 1er septembre 2026, et l'émission au format structuré deviendra obligatoire au 1er septembre 2027 pour les micro-entreprises."
  },
]
...
export default function IndyVsAbbyPage() {
  ...
  const criteria = [
    ...
    { label: 'Facturation électronique', a: '✅ Conforme',       b: '✅ Conforme',          winner: 'egal' },
    ...
    { label: 'Prix depart',              a: 'Gratuit',            b: 'Gratuit / 5,40€/mois', winner: 'indy' },
    { label: 'Adapté artisans',          a: 'Moins adapté',       b: 'Bien adapté',           winner: 'abby' },
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-xs text-gray-500 mb-4 bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 inline-block">
          Classement établi selon <Link href="/methodologie" className="text-indigo-600 hover:underline">notre grille de notation</Link> — prix, fonctionnalités, prise en main et support. Les notes sont éditoriales, pas des moyennes d&apos;avis clients.
        </p>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-10">
          ...
          <p className="text-sm text-amber-800">
            <strong>Choisissez Indy</strong> si vous êtes freelance ou profession liberale et voulez automatiser votre comptabilite via connexion bancaire.
            <br />
            <strong>Choisissez Abby</strong> si vous êtes artisan, commercant ou auto-entrepreneur cherchant un outil complet avec paiement en ligne.
          </p>
        </div>
        ...
        <p className="text-gray-600 leading-relaxed mb-4">
          Indy (anciennement Georges) est un logiciel de comptabilite et facturation lance en 2017 et utilise par plus de 300 000 indépendants en France.
          Son point fort majeur est la <strong>connexion bancaire automatique</strong> : en reliant votre compte bancaire, Indy catégorise vos transactions,
          génère votre livre des recettes et prepare vos declarations URSSAF sans aucune saisie manuelle.
        </p>
        <p className="text-gray-600 leading-relaxed mb-8">
          ...
          tableau de bord. Tout ce dont un micro-entrepreneur a besoin sans payer un centime. Le plan payant (à partir de 20€/mois) ajoute
        ...
        <p className="text-gray-600 leading-relaxed mb-10">
          Abby excelle dans la gestion commerciale : devis, factures, relances, paiement en ligne intégré, suivi clients.
          Il est particulierement bien adapté aux artisans, commercants et auto-entrepreneurs avec une activite diverse.
          Son tarif de depart (5,40€/mois en annuel) en fait l&apos;un des outils les plus accessibles du marche.
        </p>
        ...
        <h2 className="text-2xl font-bold mb-5">Tarifs détaillés 2026</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
          <div className="card p-5">
            ...
            <div className="space-y-3 text-sm">
              {[
                { label: 'Gratuit', price: '0 €/mois', green: true },
                { label: 'Micro-entrepreneur', price: '20 €/mois' },
                { label: 'EI / EIRL', price: '40 €/mois' },
                { label: 'Societe (SASU, EURL)', price: '80 €/mois' },
              ].map((t, i, arr) => (
          ...
          <div className="card p-5">
            ...
            <div className="space-y-3 text-sm">
              {[
                ...
                { label: 'Starter (annuel)', price: '5,40 €/mois' },
                { label: 'Pro (annuel)', price: '11 €/mois' },
                { label: 'Sans engagement', price: 'à partir de 9 €/mois' },
              ].map((t, i, arr) => (
                <div key={t.label} className={`flex justify-between pb-2 ${i < arr.length - 1 ? 'border-b border-gray-50' : ''}`}>
                  <span className="text-gray-600">{t.label}</span>
                  <span className={`font-semibold ${t.green ? 'text-green-600' : ''}`}>{t.price}</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
          <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-5">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              ...
              <li>&#10003; Vous êtes freelance ou profession liberale BNC</li>
              <li>&#10003; Vous cherchez la version gratuite la plus complete du marche</li>
              <li>&#10003; Vous avez un fort volume de transactions a catégoriser</li>
            </ul>
          </div>
          <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-5">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              ...
              <li>&#10003; Vous voulez le paiement en ligne intégré dans vos factures</li>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              { href: '/blog/indy-avis', title: 'Avis Indy 2026' },
