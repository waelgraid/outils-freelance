  ...
  return (
    <div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-12 pb-2">
        <Link href="/calculateur-urssaf"
          className="group relative flex flex-col sm:flex-row items-center justify-between gap-5 bg-white border border-gray-100 rounded-2xl px-7 py-6 hover:border-indigo-200 hover:shadow-md transition-all shadow-sm overflow-hidden">
          {/* Accent strip */}
          ...
          <div className="flex items-center gap-5 pl-2">
            ...
            <div>
              <div className="text-xs font-semibold text-indigo-600 uppercase tracking-wide mb-0.5">Outil gratuit</div>
              <div className="font-bold text-gray-900 text-base group-hover:text-indigo-700 transition-colors">Calculateur de cotisations URSSAF 2026</div>
              <div className="text-sm text-gray-500 mt-0.5">Estimez votre revenu net en 30 secondes — taux officiels, ACRE pris en compte</div>
            </div>
          </div>
          <div className="shrink-0 flex items-center gap-2 bg-indigo-600 text-white text-sm font-semibold px-5 py-2.5 rounded-xl group-hover:bg-indigo-700 transition-colors">
            Calculer maintenant
