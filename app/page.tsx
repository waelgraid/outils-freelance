...
export const metadata: Metadata = {
  ...
  description: 'Comparatifs indépendants de logiciels de facturation, banques pro et mutuelles pour freelances et auto-entrepreneurs. Sélection 2026 testée et mise à jour.',
  alternates: { canonical: 'https://www.outils-freelance.fr/' },
  openGraph: {
    title: 'Outils-Freelance.fr — Comparatifs pour freelances 2026',
    description: 'Logiciels de facturation, banques pro, mutuelles : comparatifs indépendants pour freelances et auto-entrepreneurs. Testés, mis à jour chaque mois.',
...
export default function HomePage() {
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-16 pb-10 text-center">
          ...
          <p className="text-lg text-gray-500 max-w-xl mx-auto leading-relaxed mb-8">
            Comparatifs indépendants de logiciels de gestion, banques pro et mutuelles — testés et sélectionnés pour les freelances et auto-entrepreneurs.
          </p>

          {/* Stats bar */}
          <div className="inline-flex items-center gap-6 sm:gap-10 bg-white border border-gray-100 shadow-sm rounded-2xl px-8 py-4 mb-10 flex-wrap justify-center">
            {[
              { value: '+50', label: 'outils étudiés' },
              { value: '9', label: 'comparés en détail' },
      ...
      <section className="bg-gray-50 py-14">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Comparer par thème</h2>
            <p className="text-gray-400 text-sm">Sélections indépendantes, mises à jour chaque mois</p>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Comment nous comparons</h2>
          <p className="text-gray-400 text-sm">Nos critères sont publics et nos sources vérifiables</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
          {[
            {
              n: '01',
              title: 'Sourcé au texte officiel',
              desc: "Legifrance, BOFiP, URSSAF : chaque règle citée renvoie à sa base légale. Nous ne reprenons jamais une information depuis un autre site de conseil.",
            },
            {
              n: '02',
              title: 'Daté et corrigé',
              desc: "Chaque fiche outil comporte une section \"inconvénients\" et une liste \"pour qui ce n'est pas adapté\". Un outil qui convient à un artisan ne convient pas à un médecin libéral.",
            },
            {
              n: '03',
              title: 'Le classement ne s\'achète pas',
              desc: "Aucun éditeur ne peut payer pour améliorer sa position. Certains outils que nous recommandons ne nous rémunèrent pas du tout, et nous le signalons.",
            },
          ].map(m => (
            <div key={m.n} className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
              <div className="text-xs font-bold text-indigo-600 mb-3 tracking-widest">{m.n}</div>
        ...
        <div className="text-center">
          <Link href="/methodologie" className="text-sm font-medium text-indigo-600 hover:underline">
