        ...
        <div className="card p-8 mb-8">
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-400 mt-1">Note basée sur les avis Trustpilot &amp; Capterra</p>
            ...
            <div className="shrink-0 text-center sm:text-right">
              ...
              <p className="text-xs text-gray-300 mt-2">Lien affilié · sans surcoût</p>
            </div>
          </div>
        </div>
