...
export const metadata: Metadata = {
  title: 'Meilleur logiciel de facturation pour électricien 2026',
  description: 'Quel logiciel de facturation pour electricien auto-entrepreneur en 2026 ? Abby, Indy : comparatif adapté aux electriciens indépendants.',
  alternates: { canonical: 'https://www.outils-freelance.fr/logiciel-facturation-electricien/' },
  openGraph: {
    title: 'Meilleur logiciel de facturation pour électricien 2026',
    description: 'Quel logiciel de facturation pour electricien auto-entrepreneur en 2026 ? Abby, Indy : comparatif adapté aux electriciens indépendants.',
    url: 'https://www.outils-freelance.fr/logiciel-facturation-electricien/',
    type: 'website',
    locale: 'fr_FR',
...
const faqItems = [
  ...
  },
  {
    ...
    "a": "Ce n'est pas une obligation legale pour un auto-entrepreneur, mais c'est fortement recommande. Un compte dédié facilite le suivi de votre activite et est exige si votre CA depasse 10 000EUR sur 2 annees consecutives. Qonto et Shine proposent des comptes pro adaptes à partir de 7,90€/mois."
  },
  {
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Meilleur logiciel de facturation pour électricien 2026</h1>
        <p className="text-gray-600 leading-relaxed mb-4 max-w-3xl">Électricien indépendant, installateur ou dépanneur, vous avez besoin d'un logiciel de facturation qui s'utilise facilement sur le terrain, gère vos fournitures, vos acomptes et votre TVA. Voici notre sélection 2026.</p>
        <p className="text-gray-600 leading-relaxed mb-8 max-w-3xl">En tant qu'électricien auto-entrepreneur, votre temps sur chantier est précieux. Votre logiciel de facturation doit vous permettre de créer un devis en quelques minutes depuis votre téléphone, de suivre vos paiements et de gérer votre comptabilité sans y passer des soirées entières.</p>

        {/* Bloc stats spécifique électricien */}
        <div className="grid grid-cols-3 gap-4 mb-10">
          <div className="rounded-2xl p-4 text-center" style={{background:'#FEFCE8',border:'1.5px solid #FEF08A'}}>
            <div className="text-2xl font-bold text-yellow-600 mb-1">78 000</div>
            <div className="text-xs text-yellow-800">électriciens indépendants en France (INSEE 2024)</div>
          </div>
          <div className="rounded-2xl p-4 text-center" style={{background:'#FEFCE8',border:'1.5px solid #FEF08A'}}>
            <div className="text-2xl font-bold text-yellow-600 mb-1">2 taux</div>
            <div className="text-xs text-yellow-800">de TVA à gérer : 10 % rénovation, 20 % neuf</div>
          </div>
          <div className="rounded-2xl p-4 text-center" style={{background:'#FEFCE8',border:'1.5px solid #FEF08A'}}>
            <div className="text-2xl font-bold text-yellow-600 mb-1">5 min</div>
            <div className="text-xs text-yellow-800">pour créer et envoyer un devis depuis le chantier</div>
          </div>
        </div>
        ...
        <div className="bg-indigo-50 border-2 border-indigo-200 rounded-2xl p-5 mb-8 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mb-2">Le plus adapté aux artisans : devis sur mobile, gestion des matériaux, TVA a 10% et 20%, acomptes. Simple et complet.</p>
            <div className="flex items-center gap-3 text-xs flex-wrap">
              <span className="text-amber-500 font-semibold">&#9733; 4.8/5</span>
              <span className="text-gray-500">À partir de 5,40€/mois</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div key="Creation de devis su" className="card p-4">
            ...
            <p className="text-sm text-gray-600">Etablir un devis sur place chez le client, integrer les fournitures et la main-d'œuvre, et envoyer par email immediatement.</p>
          </div>
          ...
          <div key="Catalogue matériaux" className="card p-4">
            <div className="font-semibold text-gray-900 mb-1">Catalogue matériaux</div>
        ...
        <div className="overflow-x-auto mb-8">
          <h2 className="text-xl font-bold mb-4">Tableau comparatif des logiciels pour électriciens</h2>
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Devis sur chantier</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Acomptes</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Catalogue matériaux</th>
              </tr>
            </thead>
            <tbody>
              {[
                { name: 'Abby', price: 'Gratuit / 6€/mois', devis: '✅', acompte: '✅', catalogue: '✅' },
                { name: 'Indy', price: 'Gratuit / 9€/mois', devis: '✅', acompte: '✅', catalogue: '⚠️ Limité' },
                { name: 'Freebe', price: '9€/mois', devis: '✅', acompte: '⚠️', catalogue: '✅' },
              ].map((row, i) => (
                <tr key={row.name} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  ...
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.devis}</td>
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.acompte}</td>
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.catalogue}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <VerdictBox
          ...
          score={4.8}
          verdictShort="Le meilleur logiciel de facturation pour électriciens — complet, mobile, abordable."
          pros={["Devis en 5 min depuis votre téléphone sur le chantier","TVA 10 % rénovation et 20 % neuf sur la même facture","Acomptes et soldes gérés automatiquement","30 jours d'essai gratuit sans CB requise"]}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <Link href="/electricien" className="card p-3.5 flex items-center gap-2 hover:border-indigo-200 group">
              <span className="text-sm font-medium group-hover:text-indigo-600">Guide complet électricien indépendant &rarr;</span>
            </Link>
            <Link href="/artisan-btp" className="card p-3.5 flex items-center gap-2 hover:border-indigo-200 group">
              <span className="text-sm font-medium group-hover:text-indigo-600">Guide complet artisan BTP &rarr;</span>
            </Link>
