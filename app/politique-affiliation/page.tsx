...
export const metadata: Metadata = {
  ...
  description: "Transparence totale sur notre modèle économique : liens affiliés, indépendance éditoriale, commissions. Comment nous finançons ce site sans frais pour nos lecteurs.",
  alternates: { canonical: 'https://www.outils-freelance.fr/politique-affiliation/' },
  openGraph: {
    title: "Politique d'affiliation — Outils-Freelance.fr",
    ...
    url: 'https://www.outils-freelance.fr/politique-affiliation/',
    type: 'website',
    locale: 'fr_FR',
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: "Politique d'affiliation", url: 'https://www.outils-freelance.fr/politique-affiliation/' },
      ]} />
            ...
            <div className="overflow-x-auto"><table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  { tool: 'Qonto', offer: '30 jours gratuits', commission: 'Forfait par client approuvé' },
                  { tool: 'Shine', offer: '30 jours gratuits', commission: 'Forfait par client approuvé' },
                  { tool: 'Pennylane', offer: '15 jours gratuits', commission: 'Forfait par client activé' },
                  { tool: 'VosFactures', offer: 'Formule gratuite (3 documents/mois)', commission: 'Aucune rémunération à ce jour' },
                  { tool: 'Alan', offer: '30 jours satisfait ou remboursé', commission: 'Aucune rémunération à ce jour' },
                  { tool: 'Wemind', offer: 'Devis personnalisé', commission: 'Aucune rémunération à ce jour' },
                  { tool: 'April Santé', offer: 'Devis personnalisé', commission: 'Aucune rémunération à ce jour' },
                ].map((r, i) => (
