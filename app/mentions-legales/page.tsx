...
export const metadata: Metadata = {
  ...
  description: "Mentions légales d'Outils-Freelance.fr : éditeur, hébergeur, propriété intellectuelle, cookies et protection des données personnelles.",
  alternates: { canonical: 'https://www.outils-freelance.fr/mentions-legales/' },
  openGraph: {
    title: 'Mentions légales — Outils-Freelance.fr',
    description: "Mentions légales d'Outils-Freelance.fr : éditeur, hébergeur, propriété intellectuelle, cookies et protection des données personnelles.",
    url: 'https://www.outils-freelance.fr/mentions-legales/',
    type: 'website',
    locale: 'fr_FR',
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: 'Mentions légales', url: 'https://www.outils-freelance.fr/mentions-legales/' },
      ]} />
