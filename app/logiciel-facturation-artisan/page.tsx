...
export const metadata: Metadata = {
  title: 'Meilleur logiciel de facturation pour artisan 2026',
  ...
  openGraph: {
    title: 'Meilleur logiciel de facturation pour artisan 2026',
    description: 'Quel logiciel de facturation pour artisan en 2026 ? Abby, Indy, Freebe : comparatif complet pour artisans et micro-entrepreneurs du batiment et artisanat.',
    url: 'https://www.outils-freelance.fr/logiciel-facturation-artisan/',
    type: 'website',
    locale: 'fr_FR',
...
const faqItems = [
  {
    ...
    "a": "Oui, c'est même indispensable. En tant qu'artisan auto-entrepreneur, vous etes soumis a l'obligation de delivrer une facture pour tout service supérieur a 25€ HT et pour toute vente a un professionnel. Un logiciel garantit la conformite de vos factures et vous evite des amendes."
  },
  {
    "q": "Quel logiciel pour un artisan sans TVA (franchise en base) ?",
    "a": "Abby et Indy gerent parfaitement la franchise en base de TVA. Vos factures afficheront automatiquement la mention 'TVA non applicable - article 293 B du CGI'. Lorsque votre CA dépassera le seuil, le logiciel s'adaptera."
  },
  {
    "q": "Peut-on utiliser Abby sur chantier depuis un telephone ?",
    "a": "Oui, Abby dispose d'une application mobile iOS et Android complete. Vous pouvez créer un devis, le faire signer par le client sur l'ecran, l'envoyer par email et suivre son statut — tout depuis votre smartphone sur le chantier."
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-indigo-50 border-2 border-indigo-200 rounded-2xl p-5 mb-8 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mb-2">Interface simple, devis sur mobile, facturation des matériaux et de la main-d'œuvre, gestion des acomptes. Le plus adapté aux artisans.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div key="Devis et factures su" className="card p-4">
            ...
            <p className="text-sm text-gray-600">Pouvoir créer un devis depuis votre smartphone chez le client, le faire signer electroniquement et le convertir en facture en un clic.</p>
          </div>
          <div key="Gestion des acomptes" className="card p-4">
            <div className="font-semibold text-gray-900 mb-1">Gestion des acomptes</div>
            <p className="text-sm text-gray-600">Facturer un acompte a la commande, suivre les encaissements et éditer la facture de solde automatiquement.</p>
          </div>
          ...
          <div key="Catalogue produits/s" className="card p-4">
            ...
            <p className="text-sm text-gray-600">Creer un catalogue de vos matériaux et prestations pour facturer rapidement sans ressaisir.</p>
          </div>
        </div>
        ...
        <div className="overflow-x-auto mb-8">
          <h2 className="text-xl font-bold mb-4">Tableau comparatif des logiciels pour artisans</h2>
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Devis mobile</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">Situations travaux</th>
                <th className="text-center px-4 py-3 border border-gray-200 font-semibold">TVA multi-taux</th>
              </tr>
            </thead>
            <tbody>
              {[
                { name: 'Abby', price: 'Gratuit / 6€/mois', devis: '✅', travaux: '✅', tva: '✅ (10% / 20%)' },
                { name: 'Indy', price: 'Gratuit / 9€/mois', devis: '✅', travaux: '⚠️ Basique', tva: '✅' },
                { name: 'Freebe', price: '9€/mois', devis: '✅', travaux: '❌', tva: '✅' },
              ].map((row, i) => (
                <tr key={row.name} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  ...
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.travaux}</td>
                  <td className="px-4 py-3 border border-gray-200 text-center">{row.tva}</td>
                </tr>
              ))}
            </tbody>
          </table>
