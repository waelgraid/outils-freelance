        ...
        <section className="mb-10">
          ...
          <div className="card p-6">
            <p className="text-gray-600 leading-relaxed mb-4">
              J'ai passé des semaines à comparer des logiciels de facturation avant de me lancer. Des semaines à lire des articles sponsorisés, des avis invérifiables, et des guides qui citaient encore des règles abrogées depuis deux ans. C'est cette dernière découverte qui m'a décidé à créer ce site.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <p className="text-gray-600 leading-relaxed mb-5">
              Mon objectif : que vous puissiez vous fier à ce que vous lisez ici, et savoir de quand ça date.
            </p>
