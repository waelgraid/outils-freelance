...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "À propos — Outils-Freelance.fr",
    description: "Qui sommes-nous ? Découvrez notre méthode d'évaluation des outils pour freelances, notre politique d'indépendance éditoriale et comment nous finançons ce site.",
    url: 'https://www.outils-freelance.fr/a-propos/',
    type: 'website',
    locale: 'fr_FR',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="mb-10">
          ...
          <div className="card p-6">
            <p className="text-gray-600 leading-relaxed mb-4">
              Comparer un logiciel de facturation ou une banque pro, c'est souvent lire des articles sponsorisés, des avis invérifiables, et des guides qui citent encore des règles abrogées depuis deux ans. C'est cette dernière découverte qui est à l'origine de ce site.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              Le problème du contenu destiné aux indépendants n'est pas qu'il manque : c'est qu'une grande partie n'est plus à jour. Ici, chaque règle est sourcée au texte officiel, chaque page affiche sa date de vérification, et une information périmée est corrigée plutôt que laissée en ligne. Si un outil a des défauts, ils sont écrits.
            </p>
            <p className="text-gray-600 leading-relaxed mb-5">
              Notre objectif : que vous puissiez vous fier à ce que vous lisez ici, et savoir de quand ça date.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="flex-1 bg-indigo-50 rounded-xl p-4">
                <div className="text-sm font-semibold text-gray-900 mb-1">📋 Notre méthode</div>
                <div className="text-xs text-gray-500"><a href="/methodologie" className="hover:text-indigo-600">Sources officielles, dates de vérification, corrections publiques →</a></div>
              </div>
              <div className="flex-1 bg-indigo-50 rounded-xl p-4">
        ...
        <section className="mb-10">
          ...
          <p className="text-xs text-gray-400 mt-2">Dernière mise à jour des évaluations : septembre 2026</p>
        </section>
