  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'WebApplication',
        name: 'Calculateur de cotisations URSSAF 2026',
        applicationCategory: 'FinanceApplication',
        operatingSystem: 'Web',
        url: 'https://www.outils-freelance.fr/calculateur-urssaf/',
        description: "Calculez vos cotisations sociales URSSAF d'auto-entrepreneur selon votre activité, votre chiffre d'affaires et votre périodicité de déclaration. Taux officiels 2026, ACRE et versement libératoire inclus.",
        inLanguage: 'fr-FR',
        isAccessibleForFree: true,
        offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR' },
        publisher: { '@type': 'Organization', name: 'Outils-Freelance.fr', url: 'https://www.outils-freelance.fr/' },
      }) }} />
