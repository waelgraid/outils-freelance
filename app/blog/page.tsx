...
export const metadata: Metadata = {
  ...
  description: "Guides pratiques 2026 pour freelances : facturation, URSSAF, TVA, mutuelles, banque pro. Articles indépendants vérifiés et mis à jour chaque mois.",
  alternates: { canonical: 'https://www.outils-freelance.fr/blog/' },
  openGraph: {
    title: 'Blog — Guides pour freelances et auto-entrepreneurs',
    description: "Guides pratiques 2026 pour freelances : facturation, URSSAF, TVA, mutuelles, banque pro. Articles indépendants vérifiés et mis à jour chaque mois.",
    url: 'https://www.outils-freelance.fr/blog/',
    type: 'website',
    locale: 'fr_FR',
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: 'Guides', url: 'https://www.outils-freelance.fr/blog/' },
      ]} />
