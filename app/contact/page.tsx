    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          Ce site est édité par une seule personne. Les messages sont lus et reçoivent une réponse,
          même si le délai peut atteindre quelques jours.
        </p>
        ...
        <div className="bg-indigo-50/60 border border-indigo-100 rounded-2xl p-6 mb-12 text-center">
          ...
          <div className="text-sm text-gray-500 mt-3">{AUTHOR.name} — {AUTHOR.role}</div>
        </div>
