...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    name: 'VosFactures',
    logo: '🧾',
    logoUrl: '/logos/vosfactures.png',
    tagline: 'Plateforme agréée DGFiP, facturation simple dès 5 € HT/mois',
    category: 'facturation',
    rating: 4.4,
    reviewCount: 0,
    price: 'À partir de 5 € HT/mois',
    priceDetail: 'Formule gratuite limitée à 3 documents/mois',
    affiliateUrl: 'https://vosfactures.fr',
    freeTrial: '30 jours gratuits',
    badge: 'Plateforme agréée',
    badgeColor: 'blue',
    pros: ['Plateforme agréée DGFiP depuis le 15 avril 2026, incluse dans toutes les formules', 'Formule payante dès 5 € HT/mois', 'Devis, factures, bons de commande, avoirs et relances', 'API ouverte et intégrations e-commerce (WooCommerce, PrestaShop, Shopify, Wix)'],
    cons: ['Pas de comptabilité intégrée', 'Formule gratuite limitée à 3 documents par mois', 'Application mobile moins complète que la version web'],
    ideal: 'Auto-entrepreneurs et TPE qui veulent une facturation conforme 2026 à petit prix, notamment en e-commerce',
    features: ['Devis et factures', 'Relances', 'Plateforme agréée', 'E-reporting', 'API', 'Intégrations e-commerce'],
    commission: 'Aucune à ce jour',
  },
  {
    slug: 'qonto',
    name: 'Qonto',
  ...
  // MUTUELLES
  {
    ...
    badge: 'Mieux noté des mutuelles',
    badgeColor: 'blue',
  ...
  },
  {
    ...
    tagline: 'La gamme santé TNS la plus large du comparatif, éligible Madelin',
    category: 'mutuelle',
    rating: 4.2,
    reviewCount: 1240,
    price: 'Sur devis',
    ...
    freeTrial: null,
    badge: 'Garanties étendues',
    badgeColor: 'blue',
    pros: ['Dentaire jusqu\'à 550 % BR (gamme Santé Pro)', 'Gamme TNS en 14 niveaux, de l\'offre budget au premium', 'Éligible Madelin pour les TNS au régime réel', 'Adhésion en ligne sans questionnaire médical'],
    cons: ['Tarif uniquement sur devis', 'Offre plus complexe à comparer que Wemind ou Alan'],
    ideal: 'Indépendants au régime réel (EI, EURL) qui veulent des garanties élevées et la déduction Madelin',
...
// Outils d'une catégorie — source unique pour les comparatifs, les cartes et les compteurs.
// Ajouter un outil ici avec sa catégorie suffit à le faire apparaître partout.
export const toolsOf = (category: Tool['category']) => TOOLS.filter(t => t.category === category)
