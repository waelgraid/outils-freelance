...
export const REVIEWS: Record<string, ToolReview> = {
  ...
  indy: {
    verdict: `Indy est notre recommandation pour tous les indépendants qui veulent automatiser leur comptabilité sans effort. Sa version gratuite est la plus généreuse du marché : facturation illimitée, connexion bancaire, déclarations URSSAF intégrées. Le service client répond en moins de 4 minutes en moyenne — difficile de faire mieux.
