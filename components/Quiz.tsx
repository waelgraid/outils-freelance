...
const RECO: Record<string, { slug: string; name: string; reason: string; href: string; affiliateUrl: string; bg: string }> = {
  // Freelance
  'freelance-facturation-gratuit':  { slug: 'indy',      name: 'Indy',      reason: 'Version gratuite complète, idéal pour démarrer en freelance.',       href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  ...
  'freelance-banque-mid':           { slug: 'qonto',     name: 'Qonto',     reason: 'La banque pro la plus complète du marché.',                          href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'freelance-banque-any':           { slug: 'qonto',     name: 'Qonto',     reason: 'La banque pro la plus complète du marché.',                          href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'freelance-compta-gratuit':       { slug: 'indy',      name: 'Indy',      reason: 'Comptabilité automatisée, version gratuite généreuse.',               href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  'freelance-compta-low':           { slug: 'indy',      name: 'Indy',      reason: 'Comptabilité automatisée via connexion bancaire.',                    href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  ...
  'artisan-banque-mid':             { slug: 'qonto',     name: 'Qonto',     reason: 'La plus fiable et complète pour les pros.',                           href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'artisan-banque-any':             { slug: 'qonto',     name: 'Qonto',     reason: 'La plus fiable et complète pour les pros.',                           href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'artisan-compta-gratuit':         { slug: 'indy',      name: 'Indy',      reason: 'Automatise votre comptabilité, version gratuite disponible.',         href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  'artisan-compta-low':             { slug: 'indy',      name: 'Indy',      reason: 'Automatise votre comptabilité facilement.',                           href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  ...
  'commercant-banque-mid':          { slug: 'qonto',     name: 'Qonto',     reason: 'La banque pro la plus complète avec gestion des dépenses.',           href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'commercant-banque-any':          { slug: 'qonto',     name: 'Qonto',     reason: 'La banque pro la plus complète avec gestion des dépenses.',           href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'commercant-compta-gratuit':      { slug: 'indy',      name: 'Indy',      reason: 'Comptabilité automatisée avec version gratuite.',                     href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  'commercant-compta-low':          { slug: 'indy',      name: 'Indy',      reason: 'Comptabilité automatisée via connexion bancaire.',                    href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  ...
  // Libéral
  'liberal-facturation-gratuit':    { slug: 'indy',      name: 'Indy',      reason: 'Parfait pour les professions libérales BNC, version gratuite.',       href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  'liberal-facturation-low':        { slug: 'indy',      name: 'Indy',      reason: 'Comptabilité BNC automatisée, déclarations 2035 incluses.',           href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  ...
  'liberal-banque-mid':             { slug: 'qonto',     name: 'Qonto',     reason: 'La banque pro la plus complète du marché.',                          href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'liberal-banque-any':             { slug: 'qonto',     name: 'Qonto',     reason: 'La banque pro la plus complète du marché.',                          href: '/outils/qonto',     affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance',     bg: '#FF5A50' },
  'liberal-compta-gratuit':         { slug: 'indy',      name: 'Indy',      reason: 'Spécialisé professions libérales BNC, gratuit pour démarrer.',        href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
  'liberal-compta-low':             { slug: 'indy',      name: 'Indy',      reason: 'Déclarations 2035 automatisées, connexion bancaire.',                 href: '/outils/indy',      affiliateUrl: 'https://www.indy.fr/inscription?ae=1514',      bg: '#6C5CE7' },
...
function getDefaultReco(need: string) {
  if (need === 'banque') return { slug: 'qonto', name: 'Qonto', reason: 'La banque pro la plus complète du marché.', href: '/outils/qonto', affiliateUrl: 'https://qonto.com/fr/open-account?ref=outils-freelance', bg: '#FF5A50' }
  if (need === 'compta') return { slug: 'indy', name: 'Indy', reason: 'Comptabilité automatisée pour tous les profils.', href: '/outils/indy', affiliateUrl: 'https://www.indy.fr/inscription?ae=1514', bg: '#6C5CE7' }
